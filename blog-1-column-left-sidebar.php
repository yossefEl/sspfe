            ...
            <div class="col-lg-8 col-12 order-1 order-lg-2 mb-40">
                <div class="row">
                    ...
                    <div class="col-12 mb-40">
                        <div class="ee-blog">
                            <a href="single-blog-left-sidebar.php" class="image"><img src="assets/images/blog/blog-10.jpg" alt="Blog Image"></a>
                            <div class="content">
                                <h3><a href="single-blog-left-sidebar.php">Latest Drone for taking sky view image and 4K video</a></h3>
                                <ul class="meta">
                    ...
                    <div class="col-12 mb-40">
                        <div class="ee-blog">
                            <div class="content">
                                <h3><a href="single-blog-left-sidebar.php">Zeon Z 5 Pro Laptop makes your life easy and simple</a></h3>
                                <ul class="meta">
                                    <li><a href="#">Momen</a></li>
                                    <li><a href="#">30 January, 2018</a></li>
                                    <li><a href="#">Comments 05</a></li>
                    ...
                    <div class="col-12 mb-40">
                        <div class="ee-blog">
                            <a href="single-blog-left-sidebar.php" class="image"><img src="assets/images/blog/blog-11.jpg" alt="Blog Image"></a>
                            <div class="content">
                                <h3><a href="single-blog-left-sidebar.php">Latest Play Station for plying exclusive games</a></h3>
                                <ul class="meta">
                                    <li><a href="#">Momen</a></li>
                                    <li><a href="#">30 January, 2018</a></li>
                                    <li><a href="#">Comments 05</a></li>
                    ...
                    <div class="col-12 mb-40">
                        <div class="ee-blog">
                            <a href="single-blog-left-sidebar.php" class="image"><img src="assets/images/blog/blog-12.jpg" alt="Blog Image"></a>
                            <div class="content">
                                <h3><a href="single-blog-left-sidebar.php">The most attractive Smart watch comming in this February</a></h3>
                                <ul class="meta">
                                    <li><a href="#">Momen</a></li>
                                    <li><a href="#">30 January, 2018</a></li>
                                    <li><a href="#">Comments 05</a></li>
